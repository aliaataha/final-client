                   ...
                   <div className='w-[300px] bg-white h-full  'onClick={(e) => e.stopPropagation()}>
                           ...
                           <div className='flex flex-wrap gap-[1rem] p-5'>
                               {
                                    color_setting.map((ele, index) => (
                                                <div className={`h-[35px] w-[calc((100%-4rem)/5)] rounded cursor-pointer`}  style={{ backgroundColor: ele }} key={index}> </div>
                                       ))
                               }
                           </div>
                      </div>
                      <div>
                         ...
                         <div className='flex gap-[1rem] pt-4 px-3'> 
                            <div className="img w-[calc((100%-1rem)/2) h-[70px]] rounded overflow-hidden cursor-pointer"><img src="/assets/light-mood.png" alt="" /></div>
                            <div className="img w-[calc((100%-1rem)/2) h-[70px]] rounded overflow-hidden cursor-pointer"><img src="/assets/dark-mood.png" alt="" /></div>
                         </div>
                      </div>
                   </div>
            </div>
